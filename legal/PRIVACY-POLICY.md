...
Thank you so much for using Piggo. To protect the app and our users, we need this user
agreement to set rules that are required to use our software. Piggo is free and open-source
software, which is totally free to use for non-commercial purposes as long as you agree to our
privacy policies.

If you have found a bug or vulnerability in the Piggo app, there are several ways to report the
