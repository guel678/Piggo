...
// Modern Forest Light Theme
val DeepForestLight = Color(0xFF1A4314)
val EmeraldGlowLight = Color(0xFF3D9970)
val MintWhisperLight = Color(0xFFA3D9B1)
val SoftSageLight = Color(0xFFDDE8D7)

// Modern Forest Dark Theme
val MidnightForestDark = Color(0xFF0A120A)
val ObsidianGreenDark = Color(0xFF162216)
val VibrantEmeraldDark = Color(0xFF4ECB71)
val SilverMintDark = Color(0xFFDDE5DD)

// Existing colors from the original app (for reference or other elements)
